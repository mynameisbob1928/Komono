import { ButtonBuilder, ButtonStyle, ActionRowBuilder, StringSelectMenuBuilder, UserSelectMenuBuilder, RoleSelectMenuBuilder, MentionableSelectMenuBuilder, ChannelSelectMenuBuilder, FileBuilder, MediaGalleryBuilder, SectionBuilder, TextDisplayBuilder, SeparatorBuilder, ThumbnailBuilder, ChannelType, SeparatorSpacingSize, Emoji } from "discord.js";

export namespace Component {
    export type ComponentType = "button" | "stringSelectMenu" | "userSelectMenu" | "roleSelectMenu" | "mentionableSelectMenu" | "channelSelectMenu" | "file" | "mediaGallery" | "section" | "textDisplay" | "separator" | "thumbnail";
    ...
    export function Create<T extends ComponentItem>(props: T):
    T extends Component.TextDisplayProps ? TextDisplayBuilder :
    T extends Component.SectionProps ? SectionBuilder :
    T extends Component.ButtonProps ? ButtonBuilder :
    T extends Component.StringSelectMenuProps ? StringSelectMenuBuilder :
    T extends Component.UserSelectMenuProps ? UserSelectMenuBuilder :
    T extends Component.RoleSelectMenuProps ? RoleSelectMenuBuilder :
    T extends Component.MentionableSelectMenuProps ? MentionableSelectMenuBuilder :
    T extends Component.ChannelSelectMenuProps ? ChannelSelectMenuBuilder :
    T extends Component.FileProps ? FileBuilder :
    T extends Component.MediaGalleryProps ? MediaGalleryBuilder :
    T extends Component.ThumbnailProps ? ThumbnailBuilder :
    T extends Component.SeparatorProps ? SeparatorBuilder :
     never {
        switch (props.type) {
            case "button": {
                // @ts-ignore
    ...
    export function CreateActionRow(props: (ButtonBuilder | StringSelectMenuBuilder | UserSelectMenuBuilder | RoleSelectMenuBuilder | MentionableSelectMenuBuilder | ChannelSelectMenuBuilder)[]) {
